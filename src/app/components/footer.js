      ...
      <div className={styles.container}>
        <div className={styles.grid}>
          <div>
            ...
            <ul className={styles.list}>
              ...
              <li><Link href="/blog/1" className={styles.link}>Blog</Link></li>
            </ul>
          </div>
        ...
        <div className={styles.bottom}>
          ...
          <div className={styles.socials}>
            <Link href="https://x.com/edufeedbrains" className={styles.icon}>
              {/* Twitter */}
            ...
            <Link href="https://facebook.com/edufeedbrains" className={styles.icon}>
              {/* Facebook */}
              <svg fill="currentColor" height="24" width="24" viewBox="0 0 256 256">
                <path d="M128,24A104,104,0,1,0,232,128,104.11,104.11,0,0,0,128,24Zm8,191.63V152h24a8,8,0,0,0,0-16H136V112a16,16,0,0,1,16-16h16a8,8,0,0,0,0-16H152a32,32,0,0,0-32,32v24H96a8,8,0,0,0,0,16h24v63.63a88,88,0,1,1,16,0Z"></path>
              </svg>
            </Link>
            <Link href="https://instagram.com/edufeedbrains" className={styles.icon}>
              {/* Instagram */}
              <svg fill="currentColor" height="24" width="24" viewBox="0 0 256 256">
